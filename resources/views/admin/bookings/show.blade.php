...
<div class="max-w-3xl">
    <div class="bg-white rounded-xl border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-t border-gray-100 bg-blue-50/50 flex items-center gap-3 justify-end">
            <a href="{{ route('admin.bookings.edit', $booking) }}" class="px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200 flex items-center gap-2">
        ...
        <div class="p-6 border-t border-gray-100 bg-red-50/50">
            <div class="flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
                ...
                <div class="flex items-center gap-3 shrink-0">
                    ...
                    @endif
                    @if ($booking->is_recurring)
                    <form action="{{ route('admin.bookings.force-destroy-recurrence', $booking) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus PERMANEN SEMUA jadwal berulang ini? ({{ $booking->recurrenceCount }} jadwal). Tindakan ini tidak dapat dibatalkan.')">
                        @csrf
                        @method('DELETE')
    ...
    <div class="mt-4">
        <a href="{{ route('admin.bookings.index') }}" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-blue-600 transition-colors">
