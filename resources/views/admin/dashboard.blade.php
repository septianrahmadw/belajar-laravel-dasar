...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl border border-gray-100 overflow-hidden">
        <div class="p-5 border-b border-gray-100 flex items-center justify-between">
            ...
            <a href="{{ route('admin.bookings.index', ['date' => now()->format('Y-m-d')]) }}" class="text-sm text-blue-600 hover:text-blue-700 font-medium">Lihat Semua</a>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-100 overflow-hidden">
        <div class="p-5 border-b border-gray-100 flex items-center justify-between">
            ...
            <a href="{{ route('admin.bookings.index') }}" class="text-sm text-blue-600 hover:text-blue-700 font-medium">Lihat Semua</a>
        </div>
        <div class="divide-y divide-gray-50">
    ...
    new Chart(document.getElementById('roomChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#4f46e5', '#2563eb', '#2563eb', '#0891b2', '#059669'],
                borderRadius: 6,
                barThickness: 20,
            }]
        },
